...
- [ ] Set up project structure and package.json with dependencies
- [ ] Create database setup with better-sqlite3 and migrations
- [ ] Configure better-auth with custom fields
- [ ] Implement custom in-memory cache with TTL
- [ ] Create middleware: requireAuth, requireRole, requireOnboarding

## Phase 2: Core Features (High Priority)

- [ ] Implement onboarding routes (role, mentor, mentee, complete)
- [ ] Implement mentor profile routes with caching
- [ ] Implement availability routes
- [ ] Implement session booking with Daily.co integration
...
### 1. Set up project structure and package.json with dependencies
- Initialize Node.js project
- Install: express, better-sqlite3, better-auth, cors, helmet, express-rate-limit, zod
...
### 4. Implement custom in-memory cache with TTL
...
### 7. Implement mentor profile routes
...
### 8. Implement availability routes
...
### 9. Implement session booking with Daily.co
